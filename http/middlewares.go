...
// routePattern 中间件，写入 context
func RoutePatternMiddleware(pattern *contextx.RoutePattern) func(http.HandlerFunc) http.HandlerFunc {
	return func(next http.HandlerFunc) http.HandlerFunc {
		return func(w http.ResponseWriter, r *http.Request) {
			log.Printf("DEBUG:RoutePatternMiddleware executed - RoutePatternMiddleware")
